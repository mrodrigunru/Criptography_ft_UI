...
/**
 * Clase que define la interfaz de descifrado del programa
 * 
 * @author Manuel Rodriguez Rodriguez
 * @version 02/05/2023
 */
public class UIDescifrado extends JFrame implements ActionListener{
...
//		name = nombre;
		...
		label2 = new JLabel("Inserta el nombre con extensión del fichero a descifrar: ");
		...
		label3 = new JLabel("Introduce la contraseña de descifrado de claves");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == botonAceptar) {
			try {
				...
				cifrado.descifrar(ficheroCif);

				JLabel bien = new JLabel("El fichero se ha descifrado correctamente");
